...
import type {
    GetDebugInfoRequest as _lnrpc_GetDebugInfoRequest,
    GetDebugInfoRequest__Output as _lnrpc_GetDebugInfoRequest__Output,
} from '../lnrpc/GetDebugInfoRequest';
import type {
    GetDebugInfoResponse as _lnrpc_GetDebugInfoResponse,
    GetDebugInfoResponse__Output as _lnrpc_GetDebugInfoResponse__Output,
} from '../lnrpc/GetDebugInfoResponse';
...
import type {
    LookupHtlcResolutionRequest as _lnrpc_LookupHtlcResolutionRequest,
    LookupHtlcResolutionRequest__Output as _lnrpc_LookupHtlcResolutionRequest__Output,
} from '../lnrpc/LookupHtlcResolutionRequest';
import type {
    LookupHtlcResolutionResponse as _lnrpc_LookupHtlcResolutionResponse,
    LookupHtlcResolutionResponse__Output as _lnrpc_LookupHtlcResolutionResponse__Output,
} from '../lnrpc/LookupHtlcResolutionResponse';
...
export interface LightningClient extends grpc.Client {
    ...
    ChannelAcceptor(
        metadata: grpc.Metadata,
        options?: grpc.CallOptions,
    ): grpc.ClientDuplexStream<_lnrpc_ChannelAcceptResponse, _lnrpc_ChannelAcceptRequest__Output>;
    ...
    GetDebugInfo(
        argument: _lnrpc_GetDebugInfoRequest,
        metadata: grpc.Metadata,
        options: grpc.CallOptions,
        callback: grpc.requestCallback<_lnrpc_GetDebugInfoResponse__Output>,
    ): grpc.ClientUnaryCall;
    GetDebugInfo(
        argument: _lnrpc_GetDebugInfoRequest,
        metadata: grpc.Metadata,
    ...
    LookupHtlcResolution(
        argument: _lnrpc_LookupHtlcResolutionRequest,
        metadata: grpc.Metadata,
        options: grpc.CallOptions,
        callback: grpc.requestCallback<_lnrpc_LookupHtlcResolutionResponse__Output>,
    ): grpc.ClientUnaryCall;
    LookupHtlcResolution(
        argument: _lnrpc_LookupHtlcResolutionRequest,
        metadata: grpc.Metadata,
    ...
    RegisterRPCMiddleware(
        metadata: grpc.Metadata,
        options?: grpc.CallOptions,
    ): grpc.ClientDuplexStream<_lnrpc_RPCMiddlewareResponse, _lnrpc_RPCMiddlewareRequest__Output>;
...
export interface LightningDefinition extends grpc.ServiceDefinition {
    ...
    GetDebugInfo: MethodDefinition<
        _lnrpc_GetDebugInfoRequest,
        _lnrpc_GetDebugInfoResponse,
        _lnrpc_GetDebugInfoRequest__Output,
        _lnrpc_GetDebugInfoResponse__Output
    >;
    ...
    LookupHtlcResolution: MethodDefinition<
        _lnrpc_LookupHtlcResolutionRequest,
        _lnrpc_LookupHtlcResolutionResponse,
        _lnrpc_LookupHtlcResolutionRequest__Output,
        _lnrpc_LookupHtlcResolutionResponse__Output
    >;
