...
const file__40swapd_proto_rawDesc = "" +
	"\n" +
	"\r40swapd.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xd3\x01\n" +
	"\rSwapInRequest\x12\x1c\n" +
	"\x05chain\x18\x01 \x01(\x0e2\x06.ChainR\x05chain\x12\x1d\n" +
	"\ainvoice\x18\x02 \x01(\tH\x00R\ainvoice\x88\x01\x01\x12$\n" +
	"\vamount_sats\x18\x03 \x01(\x04H\x01R\n" +
	"amountSats\x88\x01\x01\x12\x1b\n" +
	"\x06expiry\x18\x04 \x01(\rH\x02R\x06expiry\x88\x01\x01\x12\x1b\n" +
	"\trefund_to\x18\x05 \x01(\tR\brefundToB\n" +
	"\n" +
	"\b_invoiceB\x0e\n" +
	"\f_amount_satsB\t\n" +
	"\a_expiry\"\x96\x01\n" +
	"\x0eSwapInResponse\x12\x17\n" +
	"\aswap_id\x18\x01 \x01(\tR\x06swapId\x12\x1f\n" +
	"\vamount_sats\x18\x02 \x01(\x04R\n" +
	"amountSats\x12#\n" +
	"\rclaim_address\x18\x03 \x01(\tR\fclaimAddress\x12%\n" +
	"\x0erefund_address\x18\x04 \x01(\tR\rrefundAddress\"\xc1\x01\n" +
	"\x0eSwapOutRequest\x12\x1c\n" +
	"\x05chain\x18\x01 \x01(\x0e2\x06.ChainR\x05chain\x12\x1f\n" +
	"\vamount_sats\x18\x02 \x01(\x04R\n" +
	"amountSats\x12\x18\n" +
	"\aaddress\x18\x03 \x01(\tR\aaddress\x12:\n" +
	"\x17max_routing_fee_percent\x18\x04 \x01(\x02H\x00R\x14maxRoutingFeePercent\x88\x01\x01B\x1a\n" +
	"\x18_max_routing_fee_percent\"K\n" +
	"\x0fSwapOutResponse\x12\x17\n" +
	"\aswap_id\x18\x01 \x01(\tR\x06swapId\x12\x1f\n" +
	"\vamount_sats\x18\x02 \x01(\x04R\n" +
	"amountSats\"\"\n" +
	"\x10GetSwapInRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\"\xa6\x03\n" +
	"\x11GetSwapInResponse\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12)\n" +
	"\x10contract_address\x18\x02 \x01(\tR\x0fcontractAddress\x129\n" +
	"\n" +
	"created_at\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\tcreatedAt\x12!\n" +
	"\finput_amount\x18\x04 \x01(\x01R\vinputAmount\x12!\n" +
	"\n" +
	"lock_tx_id\x18\x05 \x01(\tH\x00R\blockTxId\x88\x01\x01\x12\x1d\n" +
	"\aoutcome\x18\x06 \x01(\tH\x01R\aoutcome\x88\x01\x01\x12#\n" +
	"\routput_amount\x18\a \x01(\x01R\foutputAmount\x12#\n" +
	"\rredeem_script\x18\b \x01(\tR\fredeemScript\x12\x1f\n" +
	"\x06status\x18\t \x01(\x0e2\a.StatusR\x06status\x120\n" +
	"\x14timeout_block_height\x18\n" +
	" \x01(\rR\x12timeoutBlockHeightB\r\n" +
	"\v_lock_tx_idB\n" +
	"\n" +
	"\b_outcome\"#\n" +
	"\x11GetSwapOutRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\"\xf4\x02\n" +
	"\x12GetSwapOutResponse\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x120\n" +
	"\x14timeout_block_height\x18\x02 \x01(\rR\x12timeoutBlockHeight\x12\x18\n" +
	"\ainvoice\x18\x03 \x01(\tR\ainvoice\x12!\n" +
	"\finput_amount\x18\x04 \x01(\x01R\vinputAmount\x12#\n" +
	"\routput_amount\x18\x05 \x01(\x01R\foutputAmount\x12\x1f\n" +
	"\x06status\x18\x06 \x01(\x0e2\a.StatusR\x06status\x129\n" +
	"\n" +
	"created_at\x18\a \x01(\v2\x1a.google.protobuf.TimestampR\tcreatedAt\x12\x1d\n" +
	"\aoutcome\x18\b \x01(\tH\x00R\aoutcome\x88\x01\x01\x12#\n" +
	"\vclaim_tx_id\x18\t \x01(\tH\x01R\tclaimTxId\x88\x01\x01B\n" +
	"\n" +
	"\b_outcomeB\x0e\n" +
	"\f_claim_tx_id\"m\n" +
	"\x1fRecoverReusedSwapAddressRequest\x12\x1a\n" +
	"\boutpoint\x18\x01 \x01(\tR\boutpoint\x12 \n" +
	"\trefund_to\x18\x02 \x01(\tH\x00R\brefundTo\x88\x01\x01B\f\n" +
	"\n" +
	"_refund_to\"a\n" +
	" RecoverReusedSwapAddressResponse\x12\x12\n" +
	"\x04txid\x18\x01 \x01(\tR\x04txid\x12)\n" +
	"\x10recovered_amount\x18\x02 \x01(\x01R\x0frecoveredAmount* \n" +
	"\x05Chain\x12\v\n" +
	"\aBITCOIN\x10\x00\x12\n" +
	"\n" +
	"\x06LIQUID\x10\x01*0\n" +
	"\aNetwork\x12\v\n" +
	"\aMAINNET\x10\x00\x12\v\n" +
	"\aTESTNET\x10\x01\x12\v\n" +
	"\aREGTEST\x10\x02*\xe7\x01\n" +
	"\x06Status\x12\v\n" +
	"\aCREATED\x10\x00\x12#\n" +
	"\x1fINVOICE_PAYMENT_INTENT_RECEIVED\x10\x01\x12\x1f\n" +
	"\x1bCONTRACT_FUNDED_UNCONFIRMED\x10\x02\x12\x13\n" +
	"\x0fCONTRACT_FUNDED\x10\x03\x12\x10\n" +
	"\fINVOICE_PAID\x10\x04\x12 \n" +
	"\x1cCONTRACT_CLAIMED_UNCONFIRMED\x10\x05\x12\b\n" +
	"\x04DONE\x10\x06\x12!\n" +
	"\x1dCONTRACT_REFUNDED_UNCONFIRMED\x10\a\x12\x14\n" +
	"\x10CONTRACT_EXPIRED\x10\b2\xb2\x02\n" +
	"\vSwapService\x12)\n" +
	"\x06SwapIn\x12\x0e.SwapInRequest\x1a\x0f.SwapInResponse\x12,\n" +
	"\aSwapOut\x12\x0f.SwapOutRequest\x1a\x10.SwapOutResponse\x122\n" +
	"\tGetSwapIn\x12\x11.GetSwapInRequest\x1a\x12.GetSwapInResponse\x125\n" +
	"\n" +
	"GetSwapOut\x12\x12.GetSwapOutRequest\x1a\x13.GetSwapOutResponse\x12_\n" +
	"\x18RecoverReusedSwapAddress\x12 .RecoverReusedSwapAddressRequest\x1a!.RecoverReusedSwapAddressResponseB\aZ\x05./rpcb\x06proto3"
