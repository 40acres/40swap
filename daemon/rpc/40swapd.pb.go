...
type SwapInResponse struct {
	...
	AmountSats    uint32                 `protobuf:"varint,3,opt,name=amountSats,proto3" json:"amountSats,omitempty"`
...
func (x *SwapInResponse) GetAmountSats() uint32 {
	if x != nil {
		return x.AmountSats
	}
	return 0
...
var file__40swapd_proto_rawDesc = string([]byte{
	...
	0x0a, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x53, 0x61, 0x74, 0x73, 0x18, 0x03, 0x20, 0x01, 0x28,
	0x0d, 0x52, 0x0a, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x53, 0x61, 0x74, 0x73, 0x12, 0x23, 0x0a,
