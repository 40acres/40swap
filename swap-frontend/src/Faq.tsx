...
const faqItems: { title: string, body: JSX.Element }[] = [{
    ...
    body: <>
        ...
        <p>
            Trustless swaps use the smart contract capabilities of bitcoin to make sure that neither 40swap or yourself
            can control all the funds at the same time. Either both transactions in the exchange happen, or none.
        </p>
    </>,
}, {
    ...
    body: <>
        <p>
            When you use your lightining node to make payments regularly, you’re channels will eventually run out of
            outbound liquidity,
            which means that you won’t be able to pay. Instead of closing existing channels and opening new ones, you
            can keep a stable channel set
            by “topping up” your outbound liquidity. You need a BTC→LN swap for that.
        </p>
        <p>
            On the contrary, if you use your node to receive payments, you need inbound liquidity, which can’t be
            obtained just by opening channels.
    ...
    body: <>
        ...
        <ol>
            ...
            <li>An on-chain mining fee for the transaction that sweeps the bitcoin from the smart contract into your
                address.
            </li>
        </ol>
        <p>
    ...
    body: <>
        <p>
            If there is any problem with your LN→BTC swap, your lightning node will make sure that your lightning
            payment is reverted
            back to you after expiration.
        </p>
        <p>
            If there is a problem with your BTC→LN swap, you’ll have to wait until the on-chain contract expires (up to
            24 hours).
    ...
    body: <>
        <p>
            You don’t have to trust us, the smart contracts that we use for swaps keep you always in control of your
            funds.
    ...
    body: <>
        <p>
            Your swap data is stored in the device you are using, which means that you can’t access it from any other
            device.
            If you clean your browsing data, or use a privacy-enhanced browser such as the tor browser, you will lose
            access to your swap history,
            and your ability to claim refunds.
        </p>
        <p>
            Before you clean your browser data or close your tor browser session, please use the “Export” functionality
            in the “History” tab.
    ...
    body: <>
        ...
        <p>
            ...
            at <a href="mailto:support@40swap.com">support@40acres.pro</a>
        </p>
    </>,
}];
...
const FaqItem: ParentComponent<{ title: string }> = (props) => {
    ...
    return <div class="faq-item">
        <div class="fw-medium fs-5">
            <span onclick={flip}><Fa icon={expanded() ? faChevronUp : faChevronDown } /></span>
